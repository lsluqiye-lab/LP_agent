...
class NarrativeBriefing(TypedDict):
    """叙事量化分析"""
    headline: str
    top_narratives: List[dict]  # theme, intensity, delta, description
    narrative_shift_warning: str
    sentiment_density: str

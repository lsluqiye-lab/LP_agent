    ...
    def get_today_orders(self) -> List[Dict[str, Any]]:
        ...
        for o in orders:
            ...
            cleaned.append({
                ...
                "quantity": float(o.submitted_quantity),
                "price": float(o.submitted_price) if o.submitted_price else None,
                "status": status_str,
    ...
    def get_history_orders(self, days: int) -> List[Dict[str, Any]]:
        ...
        for o in orders:
            ...
            cleaned.append({
                ...
                "side": str(o.side),
                "order_type": str(o.order_type),
                "quantity": float(o.submitted_quantity) if hasattr(o, 'submitted_quantity') else float(o.quantity),
                "price": float(o.submitted_price) if hasattr(o, 'submitted_price') and o.submitted_price else (float(o.price) if o.price else None),
                "status": status_str,
                "llm_status": llm_status,
                "raw_order": o,
